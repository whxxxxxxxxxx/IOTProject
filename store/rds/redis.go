...
func MustNewRedis(conf RedisConf, opts ...Option) *Redis {
	...
	if err != nil {
		logx.SystemLogger.Errorw("fail to load redis", zap.Field{Key: "err", Type: zapcore.StringType, String: err.Error()})
	}
